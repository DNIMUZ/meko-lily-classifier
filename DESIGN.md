...
- **Finding Gold** (#8a7a5c): decorative only — corner pins, the binding tie. Never text.
...
- **Don't** restyle a widget halfway — every stock control (tabs, uploader, camera) is either restitched to the world or deliberately left, never half-mixed.
